<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="meeting_room.Meeting_Room_Access.Registration" %>
    ...
    <div class="container ">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-6 ">
                <div class="login ">
                    <h1 class="signIn" style="text-align: center">Sign Up</h1>
                    <div class="wrapper">
                        <div class="box">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="wrapper">
                         ...
                         <button type="submit" class="btn btn-primary" id="Button2" runat="server" onserverclick="Button2_ServerClick">Exit</button> --%>
                                <div align="center">
                                <asp:Button type="button" ID="MyButton" class="btn btn-primary" runat="server" Text="Save" OnClick="btn_save" Style="width:79px;" />
                                    
                                <asp:Button ID="Button1" runat="server" Class="btn btn-danger" Text="Exit" OnClick="Button2_ServerClick" Style="width:79px;" />
                                </div>
