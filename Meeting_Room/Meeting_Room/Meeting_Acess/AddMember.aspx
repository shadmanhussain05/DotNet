...
<body>
            ...
            <div class="col-md-6 mt-4 ">
                ...
                <p>Logout: <span class="glyphicon glyphicon-off" class="btn btn-dangder">
                    <i class="bx bx-logout"></i>
                    <a href="LinkButton1_Click"></a>
                           </span></p>
               <%-- <button type="submit" class="btn btn-danger" id="Button1" runat="server" onserverclick="LinkButton1_Click" style="margin-right:226px; margin-right:12px; width:78px;">LogOut</button>--%>
            </div>
            </div>
