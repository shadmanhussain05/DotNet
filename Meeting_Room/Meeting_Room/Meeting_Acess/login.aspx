		...
		<div class="row">
			...
			<div class="col-12 col-xl-6 ">
				<div class="login ">
					...
					<div class="wrapper">
						<div class="box">
						<input type="text" class="text" name="userId" id="Username" placeholder=" " runat="server">
                            <span
								class="place-holder" aria-required: > <b>User Name</b></span><br />
                             <asp:CustomValidator runat="server" Display="Dynamic" ID="customValidator" ForeColor="Red"    OnServerValidate="customValidator_ServerValidate"   ErrorMessage="">  
</asp:CustomValidator> 
					...
					<div class="wrapper">
						<div class="box">
							<input type="password" class="text" name="password" id="password" placeholder=" " runat="server"> <span
								class="place-holder" ><b>Password</b> </span><br />
                             <asp:CustomValidator runat="server" Display="Dynamic" ID="customValidator1" ForeColor="Red"    OnServerValidate="customValidator_ServerValidate1"   ErrorMessage="">  
</asp:CustomValidator> 
						</div>
						<br>
					</div>
